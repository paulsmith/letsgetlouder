...
DATABASES = {
    'default': {
        ...
        'NAME': 'letsgetlouder', # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(where, 'media')
...
SECRET_KEY = 'f1q-rg5sjp3)q00@y0v(g380+#6x@e%yl7*6fkkk8(b=a8dnud'
...
ROOT_URLCONF = 'letsgetlouder.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'letsgetlouder.wsgi.application'

TEMPLATE_DIRS = (
    # Put strings here, like "/home/html/django_templates" or "C:/www/django/templates".
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    os.path.join(where, 'templates'),
)
